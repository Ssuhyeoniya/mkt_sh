...
const IBOB_SHEET_ID   = '1VSAqt5lRKMJfmKEW8jDEtmGKTAwjGpBaQdoNcNUfA4U';
const IBOB_SHEET_NAME = 'TOTAL';
...
const IBOB_DATE_KEYS = new Set([
  '시작일','종료일','IB 인입 일자','최초 협의 일자','계약서 날인 일자'
]);
